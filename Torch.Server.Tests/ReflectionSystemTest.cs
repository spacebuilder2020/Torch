...
namespace Torch.Tests
{
    public class ReflectionSystemTest
    {
        ...
        private static readonly ReflectionTestManager _manager = new ReflectionTestManager().Init(typeof(ReflectionTestBinding));
        ...
        public void TestInstanceEventReplace()
        {
            ...
            var binder = ReflectionTestBinding.TestEventReplacer.Invoke();
        ...
        public void TestInstanceFieldGet()
        {
            ...
            var testNumber = AcquireRandomNum();
            var target = new ReflectionTestTarget
            {
