...
namespace Torch.Managers.PatchManager
{
    ...
    public class MethodRewritePattern
    {
        ...
        /// <summary>
        ///     Methods capable of accepting one <see cref="IEnumerable{T}" /> and returing another, modified.
        /// </summary>
        ...
        /// <summary>
        ///     Sorts methods so that their <see cref="PatchPriorityAttribute" /> priority is in descending order.  Assumes
        ///     priority zero if no attribute exists.
        /// </summary>
