...
namespace Torch.Managers
{
    ...
    public interface IDependencyManager : IDependencyProvider
    {
        ...
        ///     When trying to determine load order before this dependency manager is
        ///     initialized
        /// </exception>
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">
        ///     When trying to determine unload order before this dependency manager is
        ///     initialized
        /// </exception>
        ...
        /// </summary>
        /// <remarks>
        ///     This method only returns false when there is already a manager registered with a type derived from this given
        ///     manager,
