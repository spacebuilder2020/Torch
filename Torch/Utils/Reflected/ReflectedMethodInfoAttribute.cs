...
{
    /// <summary>
    ///     Indicates that this field should contain the <see cref="System.Reflection.MethodInfo" /> instance for the given
    ///     method.
    /// </summary>
    ...
    public class ReflectedMethodInfoAttribute : ReflectedMemberAttribute
    {
        ...
        /// </summary>
        public string[] ParameterNames { get => Parameters.Select(x => x.AssemblyQualifiedName).ToArray(); set => Parameters = value?.Select(x => x == null ? null : Type.GetType(x)).ToArray(); }
