...
namespace Torch.Patches
{
    ...
    public static class GameAnalyticsPatch
    {
        ...
        {
            var type = Type.GetType("GameAnalyticsSDK.Net.Logging.GALogger, GameAnalytics.Mono");
            if (type == null)
                return;
            ...
            var ctor = type.GetConstructor(BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic, null, new Type[0], new ParameterModifier[0]);
            if (ctor == null)
            {
